    ...
    <div className="pt-[76px] bg-[#fbfaf6]">
      <section className="border-b border-[#dcd9d0] bg-[#f1efe8] py-20 md:py-28">
        <div className="section-shell max-w-5xl">
          ...
          <p className="mt-6 text-[#77796f]">Last updated: September 2026</p>
        </div>
      </section>
      <section className="py-20 md:py-28 bg-white">
        <div className="section-shell max-w-5xl">
          ...
          <div className="border-t border-[#b8b4a9]">
            {[
              { title: "1. Information We Collect", body: "We collect information you provide directly to us — including your name, email address, phone number, company name, project details and any optional artwork or site-photo link — when you submit a quote request or contact form." },
              ...
              { title: "6. Cookies and Measurement", body: "Our website uses cookies and similar technologies for essential operation, traffic and performance measurement, and session diagnostics, including Google Analytics and Microsoft Clarity. We also record numeric page-speed measurements with the page path, website version, approximate device size and country. This performance record does not include your quote details, IP address or a cross-session visitor identifier. You can control cookies in your browser settings, though this may affect some functionality." },
