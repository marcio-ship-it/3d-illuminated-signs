    ...
    <div className="pt-[76px] bg-[#fbfaf6]">
      <section className="border-b border-[#dcd9d0] bg-[#f1efe8] py-20 md:py-28">
        <div className="section-shell max-w-5xl">
          ...
          <p className="mt-6 text-[#77796f]">Last updated: August 2026</p>
        </div>
      </section>
        ...
        <div className="section-shell max-w-5xl">
          ...
          <div className="border-t border-[#b8b4a9]">
            {[
              ...
              { title: "6. Cookies and Measurement", body: "Our website uses cookies and similar technologies for essential operation, traffic and performance measurement, and session diagnostics, including Google Analytics and Microsoft Clarity. You can control cookies in your browser settings, though this may affect some functionality." },
